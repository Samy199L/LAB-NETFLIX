...
public class Controller {
    ...
    private void chargerDonnees() {
        Donnees source = new LecteurCSV("/data/mediasKaggleMod.csv");
        List<Media> medias = source.charger();
    ...
    private void afficherPageActuelle() {
        ...
        tableMedias.getSelectionModel().clearSelection();  // evite toute selection fantome
